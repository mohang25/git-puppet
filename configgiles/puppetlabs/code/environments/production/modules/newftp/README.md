...
1. [Setup - The basics of getting started with newftp](#setup)
    * [What newftp affects](#what-newftp-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with newftp](#beginning-with-newftp)
